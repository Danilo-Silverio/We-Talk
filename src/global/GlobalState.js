...
const GlobalState = (props) => {
    ...
    const [ chatList, setChatList ] = useState([
        ...
        {chatId: Date.now(), person:"Danilo Silvério", profilePicture: `${AvatarIcon3}`}, 
        {chatId: Date.now(), person:"Eduardo Carver", profilePicture: `${AvatarIcon2}`}, 
        {chatId: Date.now(), person:"Fernanda Bailey", profilePicture: `${AvatarIcon5}`}, 
        {chatId: Date.now(), person:"Gilmar Austin ", profilePicture: `${AvatarIcon}`}, 
        {chatId: Date.now(), person:"Higor Zardin", profilePicture: `${AvatarIcon4}`}, 
        {chatId: Date.now(), person:"Isabelle Young", profilePicture: `${AvatarIcon2}`}, 
        {chatId: Date.now(), person:"James Xavier", profilePicture: `${AvatarIcon5}`}, 
        {chatId: Date.now(), person:"Karen Willians", profilePicture: `${AvatarIcon}`}, 
